...
/*************************************************************************/
        ...
        log << "    Halogen (Cl): " << term_values[5] << '\n';
        log << "    Halogen (Br): " << term_values[6] << '\n';
        log << "    Halogen (I) : " << term_values[7] << '\n';
        log << "    Sulfur      : " << term_values[8] << '\n';
...
int main(int argc, char* argv[]) {
    ...
    * random seed the program used (this is printed when the program starts).\n\
	...
	try {
        ...
        fl weight_hal_cl      = -0.265000;//= -0.38;  //tentative
        fl weight_hal_br      = -0.320000;//= -0.45;  //tentative
        fl weight_hal_i       = -0.400000;//= -0.55;  //tentative
        fl weight_sul         = -0.320000;            //tentative
...
/*****************************************************************************************/
            ...
            ("weight_hal_Cl", value<fl>(&weight_hal_cl)->default_value(weight_hal_cl),          "Chlorine Halogen bond weight")
            ("weight_hal_Br", value<fl>(&weight_hal_br)->default_value(weight_hal_br),          "Bromine Halogen bond weight")
            ("weight_hal_I", value<fl>(&weight_hal_i)->default_value(weight_hal_i),          "Iodine Halogen bond weight")
            ("weight_Sul", value<fl>(&weight_sul)->default_value(weight_sul),          "Sulfur bond weight")
...
/*****************************************************************************************/
        ...
        weights.push_back(weight_hal_cl);
        weights.push_back(weight_hal_br);
        weights.push_back(weight_hal_i);
        weights.push_back(weight_sul);
