...
const sz XS_TYPE_S_A   = 10;
const sz XS_TYPE_S_P   = 11;
//const sz XS_TYPE_SA    = 12;    //aromatic sulfur
const sz XS_TYPE_P_P   = 12;
const sz XS_TYPE_F_H   = 13;
const sz XS_TYPE_Cl_H  = 14;
const sz XS_TYPE_Br_H  = 15;
const sz XS_TYPE_I_H   = 16;
const sz XS_TYPE_Met_D = 17;
...
inline bool xs_is_Cl(sz xs) {
    return xs == XS_TYPE_Cl_H;
}

inline bool xs_is_Br(sz xs) {
    return xs == XS_TYPE_Br_H;
}

inline bool xs_is_I(sz xs) {
    return xs == XS_TYPE_I_H;
}

inline bool xs_is_S(sz xs) {
    return xs == XS_TYPE_S_A || xs == XS_TYPE_S_P;
}
