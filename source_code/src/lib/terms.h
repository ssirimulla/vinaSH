...
struct distance_additive : public term {
    ...
    virtual fl eval(const atom_base& a, const atom_base& b, fl r, fl theta) const = 0;
...
/*************************************************************************************************************/
    ...
    fl eval(const atom_base& a, const atom_base& b, fl r, fl theta) const { // should not be overriden
        return eval(a.get(atom_typing_used), b.get(atom_typing_used), r, theta);
    }
    
/*************************************************************************************************************/
    
	//virtual fl eval(sz t1, sz t2, fl r) const { return 0; }
    virtual fl eval(sz t1, sz t2, fl r, fl theta) const { return 0; }
	virtual ~usable() {}
};
...
/*
struct angle_term : public distance_additive {
    atom_type::t atom_typing_used;
    angle_term(fl cutoff_) : distance_additive(cutoff_), atom_typing_used(atom_type::XS) {}
    fl eval(const atom_base& a, const atom_base& b, fl r, fl theta) const { // should not be overriden
        return eval(a.get(atom_typing_used), b.get(atom_typing_used), r, theta);
    }
    virtual fl eval(sz t1, sz t2, fl r, fl theta) const { return 0; }
